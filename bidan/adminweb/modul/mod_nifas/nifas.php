...
switch($_GET[act]){
  ...
  default:
    if ($_SESSION[leveluser]=='admin'){
      ...
      echo "<h2>Masukkan data pasien pelayanan Nifas pada form di bawah ini :</h2>";
     ...
     echo "<tr><td class='left'>Agama</td>  <td> : 
          <select name='agama'>
			...
			<tr><td class='left' width='100'>Menarche</td>     <td class='left'> : <input type=text name='nama_sub' size='40'></td></tr>
			<tr><td class='left' width='100'>Lama</td>     <td class='left'> : <input type=text name='nama_sub' size='40'></td></tr>
			<tr><td class='left'>Antenatal Care</td>  <td> : 
          	<select name='anc'>
            <option value=0 selected>Teratur</option>
			<option value=0 selected>Tidak Teratur</option></td></tr></select>
			<tr><td class='left' width='100'>Keluhan</td>     <td class='left'> : <input type=text name='nama_sub' size='40'></td></tr>";
