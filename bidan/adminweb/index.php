...
<!-- Header -->
<div id="header"> <h2 text align="center">LOGIN ADMIN </h2></div>
...
<form id="form-login" name="login" method="post" action="cek_login.php" onSubmit="return validasi(this)">
  ...
  <input name="Submit" type="image" value="Submit" src="images/images_login/login.jpg" id="submit" align="absmiddle" />
</form>
</div>
